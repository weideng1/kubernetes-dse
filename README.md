...
You can update the [opsc-secrets.yaml file's data:admin_password's value](https://github.com/DSPN/kubernetes-dse/blob/dev-201808/common/secrets/opsc-secrets.yaml#L7) with your own base64 encoded password. Use this command **$ echo -n '<your own password>' | base64** to generate your base64 encoded password.
```
