...
You can update the opsc-secrets.yaml file's data:admin_password's value with your own base64 encoded password. Use this command **$ echo -n '<your own password>' | base64** to generate your base64 encoded password.
```
